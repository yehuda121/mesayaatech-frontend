...
export default function ReserveDashboard() {
  ...
  const navItems = [
    { labelHe: "ראשי", labelEn: "Dashboard", path: "/pages/reserve/ReserveHomePage" },
    { labelHe: "משרות", labelEn: "Jobs", path: "/pages/jobs" },
    { labelHe: "הפרופיל שלי", labelEn: "My Profile", path: "/reserve/profile" },
  ];
